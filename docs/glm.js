...
exports.GLM = function (family) {
  ...
  model.fit = function (endogenous, exogenous) {
    //exogenous = constantize(exogenous); //Commented out to stop it adding an intercept for the model
...
exports.GLM.links.linkBuilder = function (func, inv, deriv) { //"exports.GLM.links." replacing "var " here to make it accessible
...
exports.GLM.optimization.IRLS = function (endogenous,
  ...
  while (!converged) {
   ...
   //Added by shaun killingbeck
   for (var i = 0; i < weights.length; i++){
      if(isNaN(weights[i]) == 1) throw new Error("GLM encountered NaN weights");
   }
